    ...
    return (
        <nav className="bg-gradient-to-r from-purple-500 to-blue-600 text-white shadow-lg">
            <div className="flex justify-between items-center p-4">
                {/* Logo */}
                <div>
                    <Link to="/" className="text-2xl font-bold hover:text-gray-200">Trackonomy</Link>
                </div>
                ...
                <div className="hidden md:block">
                    <Link to="/login" className="hover:bg-white hover:text-blue-600 px-4 py-2 rounded transition">Logout</Link>
                </div>
            </div>
